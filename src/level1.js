...
export default Framework.Class(Framework.Level , {
	load: function(){
        ...
        this.clock = new Framework.Sprite(imgPath + 'clock.png');
        ...
        this.secondHand = new Framework.Sprite(imgPath + 'secondHand.jpg'); 
        this.firen = new Character(imgPath + 'firen.png', {position: characterPosition, run: {from: 20, to: 22}, beHit: {from:30, to: 35}, hit: {from: 10, to: 13}}); 
        this.freeze = new Character(imgPath + 'freeze.png', {position: characterPosition, scale: 1, run: {from: 29, to: 27}, beHit: {from:39, to: 35}, hit: {from: 19, to: 16}});
